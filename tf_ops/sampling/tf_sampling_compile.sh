...
# TF1.8
g++ -std=c++11 tf_sampling.cpp tf_sampling_g.cu.o -o tf_sampling_so.so -shared -fPIC -I /home/xuyan/tensorflow_xuyan/virtual_2.7/lib/python2.7/site-packages/tensorflow/include -I /usr/local/cuda-9.0/include -I /home/xuyan/tensorflow_xuyan/virtual_2.7/lib/python2.7/site-packages/tensorflow/include/external/nsync/public -lcudart -L /usr/local/cuda-9.0/lib64/ -L/home/xuyan/tensorflow_xuyan/virtual_2.7/lib/python2.7/site-packages/tensorflow -ltensorflow_framework -O2 -D_GLIBCXX_USE_CXX11_ABI=0
